...
function FriendItem({ friend }: Props) {
  ...
  const { handleAcceptFriendRequest } = useManageFriendRequests(friend.user_id)
    ...
    <div className='card'>
      ...
      <div className='card-body relative z-10'>
        ...
        <div className='flex gap-2'>
          <button className='button flex-1 bg-primary text-white' onClick={handleAcceptFriendRequest}>
            Chấp nhận
          </button>
          <a
